...
document.querySelectorAll('#contact-form-section .row .col input').forEach(item=>{
    item.onfocus = function () {
        document.querySelectorAll('#contact-form-section .row .col').forEach(item=>{
            item.classList.remove('before');
        })
        document.querySelectorAll('#contact-form-section .row .alone-col').forEach(item=>{
            item.classList.remove('before');
        })
        item.parentElement.classList.add('before');
    }
})

document.querySelectorAll('#contact-form-section .row .alone-col input').forEach(item=>{
    item.onfocus = function () {
        document.querySelectorAll('#contact-form-section .row .col').forEach(item=>{
            item.classList.remove('before');
        })
