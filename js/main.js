...
// projects animation
document.querySelectorAll('#projects a.project').forEach(item=>{
    
        item.onmousemove = function () {
            for(let i=0;i<item.children[0].children.length;i++){
                item.children[0].children[1].classList.add("animate__slideInUp");
                item.children[0].children[2].classList.add("animate__slideInUp");
                item.children[0].children[0].classList.add('animate__slideInUp');
            }
        }
        ...
        item.onmouseleave = function () {
            ...
            for(let i=0;i<item.children[0].children.length;i++){
                item.children[0].children[1].classList.remove("animate__slideInUp");
                item.children[0].children[2].classList.remove("animate__slideInUp");
                item.children[0].children[0].classList.remove('animate__slideInUp');
            }
        }
...
document.querySelectorAll('#personal-projects a.project').forEach(item=>{
    item.onmousemove = function () {
...
document.querySelector('.scroll-projects-section').onclick = function () {
    window.scrollTo({
